...
public class ShowUtil {
	...
	public static CustomDialog getCustomDialog(Context context, int layoutId,
		...
		CustomDialog customDialog = new CustomDialog(context, contentView,dialogType);
	 ...
	 * @return
	 */
	public static CustomDialog getPhotoView(Context context, String titleStr,int dailogType,
			final PhotoResponse response) {

		final CustomDialog dialog = getCustomDialog(context,
				R.layout.select_image, 1,dailogType);
